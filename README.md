...
- 이미지 분류 및 유사 이미지 추천 프로젝트

  - 데이터 파싱 (Python-Elasticsearch)
...
- 이미지 분류 및 유사 이미지 추천 프로젝트 모델

  - FAISS 유사이미지 추천 모델 개선

  - CNN분류 모델링 -> 구글 인셉션 모델로 변경

- 이미지 분류 및 추천 프로젝트 WEB
  - 플라스크 웹구성
